...
SECRET_KEY = 'django-insecure-sm+n#@q6_voq#h*ke!3s7bdwq0dkdf_a105b_*%98t&t+x28(='
...
CRONJOBS = [
    ('0 8,10,20 * * *', 'news.cron.fetch_articles_job'),  # 8 AM, 10 AM, and 8 PM
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]   # project-level
